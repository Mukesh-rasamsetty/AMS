...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();"
	onunload="">
	<div class="heading">
		<h1 style="color: orange; font-size: 350%; font-style: italic;">
			Audit Management System</h1>
	</div>
	<img class="wave" src="/images/wave.png" width="100%" height="100%">
	<div class="container">
		<div class="img"></div>
		<div class="login-content">
			<c:choose>
				...
				<c:when test="${msg != null}">
					...
					<span>&nbsp;&nbsp;</span>
					<div>
						<a href="/loginPage"><strong>Click here</strong> to login
							again</a>
					</div>
				</c:when>
			</c:choose>
